...
/**
 * Helper: lanza browser compatible con Vercel Lambda y entorno local.
 * En Vercel usa @sparticuz/chromium. En dev usa cualquier Chrome instalado.
 */
async function launchBrowser() {
    // En Lambda (Vercel) LAMBDA_TASK_ROOT está definido
    ...
    // Dev: usar puppeteer-core apuntando a Chrome del sistema
    ...
    const executablePath = localChromePaths.find(p => existsSync(p)) || undefined;
...
async function extractDetalleCompleto(page) {
    ...
    // debug: skip fs write in production
