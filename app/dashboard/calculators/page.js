            ...
            <div className="tools-grid">
                ...
                <div className="tool-card glass-panel" style={{ borderColor: '#8b5cf6' }}> {/* Purple tint */}
                    ...
                    <form onSubmit={calcularPlazo} className="tool-form">
                        <div className="form-group">
                            <label htmlFor="plazo_fecha">Fecha de Notificación</label>
                            <input
                                id="plazo_fecha"
                        ...
                        <fieldset className="form-group full" style={{ border: 'none', padding: 0, margin: '0 0 1.5rem 0' }}>
                            ...
                            <div className="radio-group">
                                <label htmlFor="plazo_habiles" className={`radio-option ${tipoPlazo === 'habiles' ? 'active' : ''}`}>
                                    <input
                                        id="plazo_habiles"
                                        type="radio"
                                        name="tipoPlazo"
                                ...
                                <label htmlFor="plazo_corridos" className={`radio-option ${tipoPlazo === 'corridos' ? 'active' : ''}`}>
                                    <input
                                        id="plazo_corridos"
                                        type="radio"
                                        name="tipoPlazo"
                ...
                <div className="tool-card glass-panel">
                    ...
                    <form onSubmit={calcularIndemnizacion} className="tool-form">
                        <div className="form-group">
                            <label htmlFor="indem_ingreso">Fecha de Ingreso</label>
                            <input
                                id="indem_ingreso"
                                name="fecha_ingreso"
                                type="date"
                        ...
                        <div className="form-group">
                            <label htmlFor="indem_egreso">Fecha de Egreso</label>
                            <input
                                id="indem_egreso"
                                name="fecha_egreso"
                                type="date"
                        ...
                        <div className="form-group full">
                            <label htmlFor="indem_remuneracion">Mejor Remuneración (Bruta)</label>
                            <div className="input-prefix">
                                <span>$</span>
                                <input
                                    id="indem_remuneracion"
                        ...
                        <fieldset className="form-group full" style={{ border: 'none', padding: 0, margin: '0 0 1.5rem 0' }}>
                            ...
                            <div className="checkbox-grid">
                                <label htmlFor="indem_check_preaviso" className={`check-option ${includePreaviso ? 'active' : ''}`}>
                                    <input id="indem_check_preaviso" name="check_preaviso" type="checkbox" checked={includePreaviso} onChange={() => setIncludePreaviso(!includePreaviso)} />
                                    <span>Indemnización por Preaviso</span>
                                </label>
                                <label htmlFor="indem_check_sac" className={`check-option ${includeSAC ? 'active' : ''}`}>
                                    <input id="indem_check_sac" name="check_sac" type="checkbox" checked={includeSAC} onChange={() => setIncludeSAC(!includeSAC)} />
                                    <span>SAC Proporcional</span>
                                </label>
                                <label htmlFor="indem_check_vac" className={`check-option ${includeVacations ? 'active' : ''}`}>
                                    <input id="indem_check_vac" name="check_vac" type="checkbox" checked={includeVacations} onChange={() => setIncludeVacations(!includeVacations)} />
