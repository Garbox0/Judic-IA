    ...
    return (
        <div className="clients-container">
            ...
            <style jsx>{`
                ...
                .empty-state { grid-column: 1 / -1; text-align: center; color: var(--muted); padding: 4rem 2rem; background: rgba(255,255,255,0.03); border-radius: 16px; border: 1px dashed rgba(255,255,255,0.1); }
                ...
                .modal-content { width: 95%; max-width: 1200px; height: 85vh; background: #0f172a; border-radius: 20px; display: flex; flex-direction: column; overflow: hidden; border: 1px solid rgba(255,255,255,0.1); box-shadow: 0 20px 50px rgba(0,0,0,0.5); }
                .modal-header { padding: 1rem 1.5rem; background: rgba(30, 41, 59, 0.5); border-bottom: 1px solid rgba(255,255,255,0.05); display: flex; justify-content: space-between; align-items: center; flex-shrink: 0; }
                ...
                .chat-section { flex: 1; display: flex; flex-direction: column; padding: 2rem; overflow: hidden; }
                .chat-viewer { flex: 1; overflow-y: auto; display: flex; flex-direction: column; gap: 1rem; padding-right: 1rem; }
                ...
                .details-sidebar { background: rgba(15, 23, 42, 0.6); border-left: 1px solid rgba(255,255,255,0.05); overflow-y: auto; overflow-x: hidden; transition: width 0.3s ease, padding 0.3s ease, opacity 0.3s ease; }
                ...
                .details-card { background: rgba(255, 255, 255, 0.03); border-radius: 12px; border: 1px solid rgba(255,255,255,0.05); overflow: hidden; }
                ...
                .btn-toggle-details { background: transparent; border: 1px solid rgba(255,255,255,0.2); color: var(--muted); padding: 0.4rem 0.8rem; border-radius: 6px; font-size: 0.8rem; font-weight: 600; cursor: pointer; transition: 0.2s; display: flex; align-items: center; gap: 0.5rem; }
                .btn-toggle-details:hover, .btn-toggle-details.active { background: rgba(255,255,255,0.1); color: white; border-color: white; }
                
                .btn-generate-action, .btn-agenda-action, .btn-convert-action { background: rgba(255,255,255,0.1); color: var(--muted); border: 1px solid rgba(255,255,255,0.2); padding: 0.5rem 1rem; border-radius: 8px; font-weight: 700; font-size: 0.8rem; cursor: pointer; margin-right: 0.5rem; }
                .btn-delete { background: rgba(239, 68, 68, 0.2); color: #ef4444; border: 1px solid rgba(239, 68, 68, 0.5); width: 36px; height: 36px; border-radius: 8px; display: flex; align-items: center; justify-content: center; font-size: 1.2rem; cursor: pointer; transition: 0.2s; }
                ...
                @media (max-width: 768px) {
                    ...
                    .details-sidebar.open { position: absolute; top: 0; left: 0; width: 100%; height: 100%; z-index: 50; background: #0f172a; }
