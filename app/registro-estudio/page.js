...
const ENTERPRISE_PLANS = [
  ...
  { id: 'enterprise_xl', label: 'Enterprise XL', members: 'Hasta 40 miembros', price: '$449.000', period: '/mes', highlight: false },
];
        ...
        <div id="re-form-content">
          ...
          {step === 1 && (
            <section className="re-form" aria-labelledby="re-heading-1">
              ...
              {/* Referido (Opcional) */}
              <div className="re-field" style={{ marginBottom: '1.5rem' }}>
                ...
                <div style={{ position: 'relative' }}>
                  <input
                    ...
                    onChange={e => {
                      ...
                      if (e.target.value.length >= 3) validateReferral(e.target.value);
                  ...
                  {referrerName && (
                    <div style={{
                      ...
                      <CheckCircle size={14} /> Referido por: <strong>{referrerName}</strong>
                    </div>
                  )}
                </div>
              </div>
